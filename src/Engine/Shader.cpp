...
namespace Helix {
    ...
    Shader::Shader(std::string vertexShaderFile, std::string fragmentShaderFile, std::string shaderName)
    {
        this->loadShader(vertexShaderFile, fragmentShaderFile, shaderName);
    }
